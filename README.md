...
<p align="center">
  <strong>OpenClaw AI 비서를 원클릭으로 설치하세요</strong>
</p>
...
EasyClaw은 [OpenClaw](https://github.com/openclaw/openclaw) AI 비서를 **복잡한 터미널 작업 없이** 설치할 수 있는 데스크톱 인스톨러입니다.
...
| **AI 비서** | OpenClaw 기반 AI 비서와 자연어로 대화 |
| **텔레그램 연동** | 텔레그램 봇을 통해 어디서든 AI 비서 사용 |
...
OpenClaw은 [openclaw](https://github.com/openclaw) 팀이 개발한 오픈소스 AI 비서입니다.
