const translations = {
  ko: {
    ...
    'features.agent.desc':
      'Google, OpenAI, Anthropic, DeepSeek, Ollama 등 7개 제공사를 지원합니다.',
  ...
  en: {
    ...
    'features.agent.desc':
      'Supports 7 providers including Google, OpenAI, Anthropic, DeepSeek, and Ollama.',
  ...
  ja: {
    ...
    'features.agent.desc':
      'Google、OpenAI、Anthropic、DeepSeek、Ollamaなど7つのプロバイダーに対応。',
