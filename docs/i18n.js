const translations = {
  ko: {
    ...
    'features.agent.desc': 'Google, OpenAI, Anthropic, DeepSeek, GLM 등 5개 제공사를 지원합니다.',
  ...
  en: {
    ...
    'features.agent.desc': 'Supports 5 providers: Google, OpenAI, Anthropic, DeepSeek, and GLM.',
  ...
  ja: {
    ...
    'features.agent.desc': 'Google、OpenAI、Anthropic、DeepSeek、GLMなど5つのプロバイダーに対応。',
  ...
  zh: {
    ...
    'features.agent.desc': '支持Google、OpenAI、Anthropic、DeepSeek、GLM等5家供应商。',
